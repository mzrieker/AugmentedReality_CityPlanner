...
[ExecuteInEditMode]
public class ChangeHighRise : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKey(KeyCode.H) && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)) && Input.GetKey(KeyCode.RightArrow) && visible)
        {
            rotateRight();
        }
        else if (Input.GetKey(KeyCode.H) && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)) && Input.GetKey(KeyCode.LeftArrow) && visible)
        {
            rotateLeft();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKey(KeyCode.RightArrow) && visible)
        {
            translateRight();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKey(KeyCode.UpArrow) && visible)
        {
            translateForward();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKey(KeyCode.DownArrow) && visible)
        {
            translateBack();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKey(KeyCode.LeftArrow) && visible)
        {
            translateLeft();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKeyDown(KeyCode.RightAlt) && visible)
        {
            pasteModel();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKeyDown(KeyCode.Space) && visible)
        {
            changeModel();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKeyDown(KeyCode.Comma) && visible)
        {
            undo();
        }
        else if (Input.GetKey(KeyCode.H) && Input.GetKeyDown(KeyCode.Period) && visible)
        {
            redo();
        }
    }
